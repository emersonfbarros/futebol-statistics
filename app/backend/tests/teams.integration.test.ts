...
describe('App', function () {
  ...
  it('get "/teams" should return message error with http status 500 if connection with db fails', async function () {
    sinon
  ...
  it('get "/teams/:someId" should return message error with http status 500 if connection with db fails', async function () {
    sinon
